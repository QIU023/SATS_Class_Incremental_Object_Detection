GPU=1,2
CUDA_VISIBLE_DEVICES=${GPU} python tools/train_net.py --num-gpus 2 --config-file ./configs/PascalVOC-Detection/SATS_ViTDet/base_19.yaml SOLVER.IMS_PER_BATCH 6 SOLVER.BASE_LR 0.005 MODEL.BACKBONE.NAME 'build_mixt_backbone' 
