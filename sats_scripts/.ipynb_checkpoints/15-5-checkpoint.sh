...
CUDA_VISIBLE_DEVICES=${GPU} python tools/train_net.py --num-gpus 1 --config-file ./configs/PascalVOC-Detection/SATS_ViTDet/base_15.yaml SOLVER.IMS_PER_BATCH 8 SOLVER.BASE_LR 0.005 MODEL.BACKBONE.NAME 'build_mixt_backbone' 
